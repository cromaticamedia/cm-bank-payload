  ...
  return (
    <div className={cn('flex flex-col gap-3 leading pt-2 sm:pt-4 lg:pt-7 w-full', className)}>
      ...
      <Typography
        ...
        variant="label1"
        htmlTag="h1"
        className="font-primary text-neutral-100 dark:text-white leading-1 font-primary font-bold text-shadow-lg text-shadow-neutral-800/40 dark:text-shadow-neutral-100/80"
      />
      {subtitle && (
        <Typography
          text={subtitle}
